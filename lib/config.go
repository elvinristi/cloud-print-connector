...
const (
	...
	ConnectorHomeURL = "https://github.com/elvinristi/cloud-print-connector"
...
var (
	...
	// go install -ldflags "-X github.com/elvinristi/cloud-print-connector/lib.BuildDate=`date +%Y.%m.%d`"
	BuildDate = "DEV"
